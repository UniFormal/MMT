...
lazy val api = (project in file("mmt-api")).
  ...
  settings(
    ...
    libraryDependencies += "org.eclipse.rdf4j" % "rdf4j-repository-sail" % "4.3.0-M1",
    libraryDependencies += "org.eclipse.rdf4j" % "rdf4j-sail-memory" % "4.3.0-M1",
    libraryDependencies += "org.eclipse.rdf4j" % "rdf4j-sparqlbuilder" % "4.3.0-M1",
    libraryDependencies += "org.eclipse.rdf4j" % "rdf4j-rio-rdfxml" % "4.3.0-M1",
    libraryDependencies += "org.eclipse.rdf4j" % "rdf4j-rio-binary" % "4.3.0-M1"
  )
