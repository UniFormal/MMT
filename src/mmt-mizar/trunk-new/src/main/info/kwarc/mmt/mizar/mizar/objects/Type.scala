...
class MizFunc(val name : String, val aid : String, val kind : String, val absnr : Int, val args : List[MizTerm]) extends MizTerm
 ...
 */
class MizAdjective(val name : String, val value : Boolean, val terms : List[MizTerm])
