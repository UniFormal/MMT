...
class AddImpacts(memory: ROMemory) extends ImpactPropagator(memory) {
  ...
  */
   ...
   * @param impCons impacted constant, a change that have an impact on the impacted constant
   ...
   * @param impCons impacted constant, a change type, a changed constant that have an impact on the impacted constant
   ...
   * @param chgType change type, the changed constant's name
   ...
   * @param chgType change type, the changed constant's name, the type of the changed constant
   * @return a literal of type string explaining the change and its impact
   */
