...
/**
  ...
  * @param source the element from which it was generated
  * @param by the Scala object that did the generation
  * @param validSince generation time for change management
  */
case class GeneratedFrom(source: ContentPath, by: AnyRef, validSince: Option[Long]) extends Origin
