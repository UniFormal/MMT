...
case class SourceError(
 ...
 ) extends Error(origin + ": source error at " + ref.region.start.twoDimString + ": " + mainMessage) {
...
case class InvalidElement(path: Path, s : String, causedBy: Error = null) extends Invalid("invalid element: " + s + ": " + path.toPath) {
