...
import Level.{ IMax, Max, _ }

import scala.annotation.tailrec
import scala.language.implicitConversions

sealed abstract class Level {
  def toShort: String = this match {
    case Zero => "type"
    case Offset(n,Zero) => s"type$n"
    case Succ(a) => s"LevSucc(${a.toShort})"
    case Max(a, b) => s"LevMax(${a.toShort}, ${b.toShort})"
    case IMax(a, b) => s"LevIMax(${a.toShort}, ${b.toShort})"
