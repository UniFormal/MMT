...
\begin{elemdescr}
  ...
  \xmlcomment{Here, a symbol can be a constant, a structure, or a notation. Definitions are actually not supported yet and only added for symmetry.}
\end{elemdescr}
...
\begin{elemdescr}
  ...
  \xmlcomment{An assignment can be an assignment to a constant or an assignment to a structure.}
\end{elemdescr}
...
\begin{elemdescr}
  ...
  \end{attdescr}
  \children{}{}
  \xmlcomment{Contrary to a defined symbol, an alias is transparent and does not introduce a new symbol.}
\end{elemdescr}
...
\begin{elemdescr}
  ...
  \end{attdescr}
  \children{term}{}
  \xmlcomment{The child is the term that is assigned to the constant.}
\end{elemdescr}
...
\begin{elemdescr}
  ...
  \end{attdescr}
  \children{morph}{}
  \xmlcomment{The child is the morphism that is assigned to the constant.}
\end{elemdescr}
...
\begin{elemdescr}
  ...
  \end{attdescr}
  \children{}{}
  \xmlcomment{\snippet{X} may be any document, module, or symbol level label.}
  \xmlcomment{These elements may carry additional attributes if their key and value are identical to those in the referenced element.}
\end{elemdescr}
