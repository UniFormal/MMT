...
case class NotFound(p : Path) extends jomdoc.Error("Cannot find ressource " + p.toString)
...
class Backend(reader : Reader, report : jomdoc.frontend.Report) {
