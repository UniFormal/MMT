...
object Export {	
	...
	def main(args: Array[String]) {
		...
		*/
		...
		val source : File = new File("E:\\Fall10\\CompSem\\Project\\OWLMMT\\Test\\Axioms\\objectPropertyAxiom.omdoc")		
		val target : File = new File("E:\\Fall10\\CompSem\\Project\\OWLMMT\\Test\\Axioms\\objectPropertyAxiomToOWL.owl") 
