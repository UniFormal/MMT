...
class MizNotation(val name : String, val aid : String, val kind : String, val constrAid : String, val constrName : String, val antonymic : Boolean) extends MizAny
...
class MizSelector(val name : Option[String], val aid : String, val absnr : Int)
class MizStructDef(val name : Option[String], val aid : String, val absnr : Int, val imports : List[MizTyp], val selectors: List[MizSelector]) extends MizAny
